...
public class Constants {
    ...
    public static final String TABLE_STOCK_HISTORICAL = "STOCK_HISTORICAL";
    ...
    public static final String SCRAPE_DATA_FROM_YAHOO = stockSourceNames[0];
    public static final String SCRAPE_DATA_FROM_INVESTOPEDIA = stockSourceNames[1];
}