...
public class StockSummaryTest {
    ...
    */
   	@Test
        public void testsetSource () {
            StockSummary instance = new StockSummary();
            String summarySource = "Yahoo";
            String expResult = "Yahoo";
            instance.setSource(summarySource);
            String result = instance.getSource();
            assertEquals(expResult, result);
        }
    ...
    */
    ...
    /* Test of getStock_record_date
    * 
    */
    @Test
    public void testgetStock_record_date () {
        StockSummary instance = new StockSummary();
        instance.setStock_record_date("2019-04-01");
        String expResult = "2019-04-01";
        String result = instance.getStock_record_date();
        assertEquals(expResult, result);
    }

    /* Test of setStock_record_date
    * 
    */
    @Test
    public void testsetStock_record_date () {
        StockSummary instance = new StockSummary();
        String stockDate = "2019-04-01";
        String expResult = "2019-04-01";
        instance.setStock_record_date(stockDate);
        String result = instance.getStock_record_date();
        assertEquals(expResult, result);
    }
